...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Kakao SDK 초기화
        KakaoSdk.init(this, "acc43ca9a8640780b7301124325af486");
        NaverIdLoginSDK.INSTANCE.initialize(this, "3CBf0H28ubR2v9NsrbdT", "j94rIo8G_2", "Project02_LastProject");
        naverLogin();
    ...
    public void kakaoLogin(Context context){
        ...
        //kotlin은 경우에 따라서 생성자 대신에 메소드로 객체를 return 받음. UserApiClient name = new  .....x =>UserApiClient.{static UserApiClient.methd}
    ...
    //나중에 재사용이 가능하게 common 클래스에 넣어두면 좋음
