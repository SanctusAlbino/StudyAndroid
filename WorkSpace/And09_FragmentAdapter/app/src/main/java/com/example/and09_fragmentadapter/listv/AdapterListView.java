...
public class AdapterListView extends BaseAdapter {
    ...
    // 어댑터는 LayoutInflater가 기본적으로 필요한데, 해당하는 객체를 상위 (나를 사용한는 지역)에서 받아 와야한다.
    ...
    //목록을 보여줄때 사용된 Object(DTO)가있다면 해당하는 DTO를 리턴하기 위한 메소드.
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView img_profile = convertView.findViewById(R.id.img1);
